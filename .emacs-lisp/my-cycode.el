...
(load-library "~/.emacs-lisp/multi-gud.el")
(load-library "~/.emacs-lisp/multi-gdb-ui.el")

;;==================================================
;;cedet插件设置
;;==================================================
(add-to-list 'load-path "~/.emacs-lisp/cedet-1.1/speedbar")
(add-to-list 'load-path "~/.emacs-lisp/cedet-1.1/eieio")
(add-to-list 'load-path "~/.emacs-lisp/cedet-1.1/semantic")
